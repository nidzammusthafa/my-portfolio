...
const MobileTOC = ({ headings }: MobileTOCProps) => {
  ...
  return (
    <>
      <button
        onClick={toggleTOC}
        className="fixed top-1/2 left-0 -translate-y-1/2 z-50 p-2 bg-accent text-dark-navy rounded-r-lg shadow-lg lg:hidden"
          ...
          {headings.map((heading) => (
            ...
            >
              <a
                ...
                className="block py-1 text-slate hover:text-accent transition-colors duration-200"
              >
                {heading.text}
              </a>
            </li>
